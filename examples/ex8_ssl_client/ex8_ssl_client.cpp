...
int main()
{
//g++ -c -std=gnu++14 -I../../include -o ex8_ssl_client.o ./ex8_ssl_client.cpp
//g++ -o ex8_ssl_client ex8_ssl_client.o -lboost_system -lboost_thread -lpthread -lboost_regex -licui18n -lssl
